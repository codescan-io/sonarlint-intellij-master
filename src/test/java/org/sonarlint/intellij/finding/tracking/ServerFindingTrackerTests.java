...
class ServerFindingTrackerTests extends AbstractSonarLintLightTests {
  ...
  @Test
  void should_track_server_issue_based_on_rule_key() {
    var serverIssue = createRangeStoredIssue(1, "issue 1", 10);
  ...
  @Test
  void should_track_server_issue_based_on_issue_key_even_if_no_other_attributes_matches() {
    var serverIssueKey = "dummyServerIssueKey";
  ...
  @Test
  void should_ignore_server_issue_if_not_matched() {
